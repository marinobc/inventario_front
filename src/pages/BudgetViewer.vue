    ...
    <div class="bpwin-wrapper">
        ...
        <div class="bpwin-container">
            <div class="aspect-ratio-box">
                <iframe
                    src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSHF8MZcdfbyZx6HyuZZi5FlhU80lVRZdCJdynC5QURU3W_UhiUJZKfpDj-et0PAx84Drym6vpdw76x/pubhtml?widget=true&amp;headers=false"
                    class="bpwin-iframe" title="Google Sheets Report" />
            </div>
        </div>
    </div>
</template>
